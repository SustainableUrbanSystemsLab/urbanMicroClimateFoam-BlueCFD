...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(viewFactorUpdated, 0);
        addToRadiationRunTimeSelectionTables(viewFactorUpdated);
    }
}
...
void Foam::radiation::viewFactorUpdated::initialise()
{
...
Foam::radiation::viewFactorUpdated::viewFactorUpdated(const volScalarField& T)
:
...
Foam::radiation::viewFactorUpdated::viewFactorUpdated
(
...
bool Foam::radiation::viewFactorUpdated::read()
{
...
void Foam::radiation::viewFactorUpdated::insertMatrixElements
(
...
void Foam::radiation::viewFactorUpdated::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiation::viewFactorUpdated::Rp() const
{
...
Foam::radiation::viewFactorUpdated::Ru() const
{
