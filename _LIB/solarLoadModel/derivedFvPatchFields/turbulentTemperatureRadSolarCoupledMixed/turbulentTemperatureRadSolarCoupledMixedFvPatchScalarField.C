...
#include "turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField.H"
...
turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField::
turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField
(
    const fvPatch& p,
...
turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField
(
    const turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField& psf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    ...
    QsNbrName_(dict.lookup("QsNbr")),
    QsName_(dict.lookup("Qs"))	
{
...
void turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    const turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField&
        nbrField = refCast
            <const turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField>
            (
...
void turbulentTemperatureRadSolarCoupledMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
