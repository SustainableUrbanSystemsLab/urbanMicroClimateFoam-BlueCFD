...
{
    defineTypeNameAndDebug(MartilliWall, 0);
...
Foam::buildingMaterialModels::MartilliWall::MartilliWall
(
    const word& name,
...
void Foam::buildingMaterialModels::MartilliWall::update_w_C_boundary(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label patchi, label patchFacei)
{
    List<scalar> reta; reta.setSize(2); reta[0]=-4.796e-5; reta[1]=-2.041e-5;
    List<scalar> retn; retn.setSize(2); retn[0]=1.5; retn[1]=3.8;
    List<scalar> retm; retm.setSize(2); retm[0]=0.333; retm[1]=0.737;
...
void Foam::buildingMaterialModels::MartilliWall::update_Krel_cell(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label& celli)
{
...
void Foam::buildingMaterialModels::MartilliWall::update_Krel_boundary(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label patchi, label patchFacei)
{
...
void Foam::buildingMaterialModels::MartilliWall::update_Kv_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label& celli)
{
    scalar rho_l = 1.0e3; 
...
void Foam::buildingMaterialModels::MartilliWall::update_Kv_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
...
void Foam::buildingMaterialModels::MartilliWall::update_Kpt_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label& celli)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::MartilliWall::update_Kpt_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::MartilliWall::update_lambda_boundary(const volScalarField& w, volScalarField& lambda, label patchi, label patchFacei)
{

    lambda.boundaryField()[patchi][patchFacei] = 1.541+0*w.boundaryField()[patchi][patchFacei]/1000;
}
