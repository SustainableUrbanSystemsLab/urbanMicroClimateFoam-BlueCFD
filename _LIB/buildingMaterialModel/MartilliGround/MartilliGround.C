...
{
    defineTypeNameAndDebug(MartilliGround, 0);
...
Foam::buildingMaterialModels::MartilliGround::MartilliGround
(
    const word& name,
...
:
    ...
    MartilliGroundCoeffs_(buildingMaterialProperties.subDict(typeName + "Coeffs")),
    rho_("rho", dimensionSet(1, -3, 0, 0, 0), MartilliGroundCoeffs_.lookup("rho")),
    cap_("cap", dimensionSet(0, 2, -2, -1, 0), MartilliGroundCoeffs_.lookup("cap"))
    /*Ks_(MartilliGroundCoeffs_.lookup("Ks")),
    theta_s_(MartilliGroundCoeffs_.lookup("theta_s")),
    theta_r_(MartilliGroundCoeffs_.lookup("theta_r")),
    alpha_(MartilliGroundCoeffs_.lookup("alpha")),
    beta_(MartilliGroundCoeffs_.lookup("beta")),
    gamma_(MartilliGroundCoeffs_.lookup("gamma")),
    A_(MartilliGroundCoeffs_.lookup("A")),
    Ss_(MartilliGroundCoeffs_.lookup("Ss"))*/
{
...
bool Foam::buildingMaterialModels::MartilliGround::read
(
    const dictionary& buildingMaterialProperties
)
{
    ...
    MartilliGroundCoeffs_.lookup("rho") >> rho_.value();
    MartilliGroundCoeffs_.lookup("cap") >> cap_.value();

    /*MartilliGroundCoeffs_.lookup("Ks") >> Ks_;
    MartilliGroundCoeffs_.lookup("theta_s") >> theta_s_;
    MartilliGroundCoeffs_.lookup("theta_r") >> theta_r_;
    MartilliGroundCoeffs_.lookup("alpha") >> alpha_;
    MartilliGroundCoeffs_.lookup("beta") >> beta_;
    MartilliGroundCoeffs_.lookup("gamma") >> gamma_;
    MartilliGroundCoeffs_.lookup("A") >> A_;
    MartilliGroundCoeffs_.lookup("Ss") >> Ss_;*/

    return true;
}

//- Correct the buildingMaterial moisture content (cell)
void Foam::buildingMaterialModels::MartilliGround::update_w_C_cell(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label& celli)
{
...
void Foam::buildingMaterialModels::MartilliGround::update_w_C_boundary(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label patchi, label patchFacei)
{
    List<scalar> reta; reta.setSize(2); reta[0]=-4.796e-5; reta[1]=-2.041e-5;
    List<scalar> retn; retn.setSize(2); retn[0]=1.5; retn[1]=3.8;
    List<scalar> retm; retm.setSize(2); retm[0]=0.333; retm[1]=0.737;
...
void Foam::buildingMaterialModels::MartilliGround::update_Krel_cell(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label& celli)
{
...
void Foam::buildingMaterialModels::MartilliGround::update_Krel_boundary(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label patchi, label patchFacei)
{
...
void Foam::buildingMaterialModels::MartilliGround::update_Kv_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label& celli)
{
    scalar rho_l = 1.0e3; 
...
void Foam::buildingMaterialModels::MartilliGround::update_Kv_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
...
void Foam::buildingMaterialModels::MartilliGround::update_Kpt_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label& celli)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::MartilliGround::update_Kpt_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::MartilliGround::update_lambda_cell(const volScalarField& w, volScalarField& lambda, label& celli)
{

    lambda.internalField()[celli] = 0.667+0*w.internalField()[celli]/1000;
}

//- Correct the buildingMaterial lambda (boundary)
void Foam::buildingMaterialModels::MartilliGround::update_lambda_boundary(const volScalarField& w, volScalarField& lambda, label patchi, label patchFacei)
{

    lambda.boundaryField()[patchi][patchFacei] = 0.667+0*w.boundaryField()[patchi][patchFacei]/1000;
}
