...
{
    defineTypeNameAndDebug(Plywood, 0);
...
Foam::buildingMaterialModels::Plywood::Plywood
(
    const word& name,
...
:
    ...
    PlywoodCoeffs_(buildingMaterialProperties.subDict(typeName + "Coeffs")),
    rho_("rho", dimensionSet(1, -3, 0, 0, 0), PlywoodCoeffs_.lookup("rho")),
    cap_("cap", dimensionSet(0, 2, -2, -1, 0), PlywoodCoeffs_.lookup("cap"))  
    /*Ks_(PlywoodCoeffs_.lookup("Ks")),
    theta_s_(PlywoodCoeffs_.lookup("theta_s")),
    theta_r_(PlywoodCoeffs_.lookup("theta_r")),
    alpha_(PlywoodCoeffs_.lookup("alpha")),
    beta_(PlywoodCoeffs_.lookup("beta")),
    gamma_(PlywoodCoeffs_.lookup("gamma")),
    A_(PlywoodCoeffs_.lookup("A")),
    Ss_(PlywoodCoeffs_.lookup("Ss"))*/
{
...
bool Foam::buildingMaterialModels::Plywood::read
(
    const dictionary& buildingMaterialProperties
)
{
    ...
    PlywoodCoeffs_.lookup("rho") >> rho_.value();
    PlywoodCoeffs_.lookup("cap") >> cap_.value();    

    /*PlywoodCoeffs_.lookup("Ks") >> Ks_;
    PlywoodCoeffs_.lookup("theta_s") >> theta_s_;
    PlywoodCoeffs_.lookup("theta_r") >> theta_r_;
    PlywoodCoeffs_.lookup("alpha") >> alpha_;
    PlywoodCoeffs_.lookup("beta") >> beta_;
    PlywoodCoeffs_.lookup("gamma") >> gamma_;
    PlywoodCoeffs_.lookup("A") >> A_;
    PlywoodCoeffs_.lookup("Ss") >> Ss_;*/

    return true;
}

//- Correct the buildingMaterial moisture content (cell)
void Foam::buildingMaterialModels::Plywood::update_w_C_cell(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label& celli)
{
...
void Foam::buildingMaterialModels::Plywood::update_w_C_boundary(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label patchi, label patchFacei)
{
    List<scalar> reta; reta.setSize(1); reta[0]=-8.0e-8;
    List<scalar> retn; retn.setSize(1); retn[0]=1.6e0;
    List<scalar> retm; retm.setSize(1); retm[0]=0.375e0;
...
void Foam::buildingMaterialModels::Plywood::update_Krel_cell(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label& celli)
{
...
void Foam::buildingMaterialModels::Plywood::update_Krel_boundary(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label patchi, label patchFacei)
{
...
void Foam::buildingMaterialModels::Plywood::update_Kv_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label& celli)
{
    scalar rho_l = 1.0e3; 
...
void Foam::buildingMaterialModels::Plywood::update_Kv_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
...
void Foam::buildingMaterialModels::Plywood::update_Kpt_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label& celli)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::Plywood::update_Kpt_boundary(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_pt, label patchi, label patchFacei)
{
    scalar rho_l = 1.0e3; 
    scalar R_v = 8.31451*1000/(18.01534); 
    scalar L_v = 2.5e6;
...
void Foam::buildingMaterialModels::Plywood::update_lambda_cell(const volScalarField& w, volScalarField& lambda, label& celli)
{

    lambda.internalField()[celli] = 0.1;
}

//- Correct the buildingMaterial lambda (boundary)
void Foam::buildingMaterialModels::Plywood::update_lambda_boundary(const volScalarField& w, volScalarField& lambda, label patchi, label patchFacei)
{

    lambda.boundaryField()[patchi][patchFacei] = 0.1;
}
